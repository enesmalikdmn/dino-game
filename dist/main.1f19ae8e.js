...
var dino = document.getElementById('dinosour');

var jumpDino = function jumpDino() {
...
var isAlive = setInterval(function () {
  ...
  var dinoTop = parseInt(window.getComputedStyle(dino).getPropertyValue('top'), 10);
  var cactusleft = parseInt(window.getComputedStyle(dino).getPropertyValue('left'), 10);
